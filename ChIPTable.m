...
%             id = geneid{i};
%         end
%         fprintf(fid,'%s\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n',char(id),enrich(i,1),enrich(i,2),enrich(i,3),...
...
%                 enrich(i,59),enrich(i,60),enrich(i,61),enrich(i,62),enrich(i,63),enrich(i,64));
%     end
...
for anno = 1:length(annot)
    ...
    for typ = 1:length(type)
        for i = 1:length(IP)-1
            ...
            fid = fopen(sprintf('%s_%s_%s_peakcentric.txt',type{typ},IP{i},annot{anno}),'w');
            ...
            for j = 1:length(peaks{1})
                ...
                for closgene = 1:3
                    if closgene > length(index)
                        genelist{closgene} = 'NaN';
                        continue
                    end
                ...
                maxenrich(4) = max(Express_ES_GRO.('chip').(chrom{1})(range));
                ...
                maxenrich(8) = max(NoExpress_ES_GRO.('chip').(chrom{1})(range));
                ...
                maxenrich(12) = max(Unique_ES_GRO.('chip').(chrom{1})(range));
                ...
                maxenrich(16) = max(CSEM_ES_GRO.('chip').(chrom{1})(range));

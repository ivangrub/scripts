function varargout = ClaudiaGUI(varargin)
%CLAUDIAGUI M-file for ClaudiaGUI.fig
%      CLAUDIAGUI, by itself, creates a new CLAUDIAGUI or raises the existing
%      singleton*.
%
%      H = CLAUDIAGUI returns the handle to a new CLAUDIAGUI or the handle to
%      the existing singleton*.
%
%      CLAUDIAGUI('Property','Value',...) creates a new CLAUDIAGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to ClaudiaGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      CLAUDIAGUI('CALLBACK') and CLAUDIAGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in CLAUDIAGUI.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help ClaudiaGUI

% Last Modified by GUIDE v2.5 16-Apr-2011 16:58:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ClaudiaGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @ClaudiaGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before ClaudiaGUI is made visible.
function ClaudiaGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for ClaudiaGUI
...
% UIWAIT makes ClaudiaGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = ClaudiaGUI_OutputFcn(hObject, eventdata, handles)

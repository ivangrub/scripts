function varargout = TeppeiGUI(varargin)
%TEPPEIGUI M-file for TeppeiGUI.fig
%      TEPPEIGUI, by itself, creates a new TEPPEIGUI or raises the existing
%      singleton*.
%
%      H = TEPPEIGUI returns the handle to a new TEPPEIGUI or the handle to
%      the existing singleton*.
%
%      TEPPEIGUI('Property','Value',...) creates a new TEPPEIGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to TeppeiGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      TEPPEIGUI('CALLBACK') and TEPPEIGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in TEPPEIGUI.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help TeppeiGUI

% Last Modified by GUIDE v2.5 20-Apr-2011 11:42:16

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TeppeiGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @TeppeiGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before TeppeiGUI is made visible.
function TeppeiGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for TeppeiGUI
handles.output = hObject;
handles.x = load('TeppeiGUI.mat');
...
% UIWAIT makes TeppeiGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = TeppeiGUI_OutputFcn(hObject, eventdata, handles)
